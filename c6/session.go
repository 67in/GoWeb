...
func Register(name string, provide Provider)  {
	if provide == nil{
		panic("session: Register provied is nil")
	}
...
type ManagerConfig struct {
	...
	SessionIDPrefic string `json:"sessionIDPrefix"`
}
...
func NewManager(provideName string, cf *ManagerConfig)(*Manager, error){
	...
	if cf.EnableSidInHTTPHeader{
		...
		if cf.SessionNameInHTTPHeader!=strMimeHeader{
			strErrMsg := "SessionNameInHTTPHeader("+cf.SessionNameInHTTPHeader+")hans the wrong format, it should be like this:"+ strMimeHeader
...
func (manager *Manager)sessionID() (string,error) {
	...
	return manager.config.SessionIDPrefic+hex.EncodeToString(b), nil
}
